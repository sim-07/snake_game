...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        { // window.pollEvent(event) prende l'ultimo evento dalla coda interna di SFML e lo copia nell'oggetto "event"
            if (event.type == sf::Event::Closed)
            { // controlla se l'evento è la chiusura della finestra
                window.close();
            }
